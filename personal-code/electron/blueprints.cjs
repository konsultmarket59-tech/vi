...
const MODULES = [
  ...
  },
  {
    ...
    core: false,
    description:
      "Финансовая модель: прогноз продаж, налоги, окупаемость, точка безубыточности. " +
      "Книга Excel на живых формулах и заключение экономиста.",
  },
  {
    id: "stories",
    name: "Видео-сторис",
    core: false,
    description:
      "Вертикальные ролики: плашки, таймлайны, иконки, SVG, голова в кружке и графика поверх " +
      "своего или стокового видео. Собирается на компьютере, ffmpeg в комплекте.",
  },
  {
    id: "cleanup",
    name: "Клининг",
  ...
  },
  {
    ...
    name: "Видео-сторис",
    core: false,
    description: "Вертикальные ролики из своих кадров и текста: раскадровка, озвучка, сборка.",
  },
  {
    id: "library",
    name: "Видеотека",
    core: false,
    description: "Свои записи как источник: расшифровка, поиск по сказанному, разговор с содержимым.",
  },
  {
    id: "catalog",
    name: "Каталог",
    core: false,
    description: "Выгрузка 1С в файл для интернет-магазина: описания, фото по кадастру, таблица с правкой.",
  },
  {
    id: "sites",
    name: "Сайты",
    core: false,
    description: "Сборка сайта из материалов в блоки под Тильду: прототип с дизайном и референсами.",
  },
