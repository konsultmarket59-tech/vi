...
const DEFAULT_SETTINGS = {
  ...
  // И ветка в нём. main — то, что уже принято и слито: рабочая ветка чата
  // отстала от него на десятки коммитов, и копии собирались из старого кода,
  // хотя исправления давно лежали в main.
  sourceBranch: "main",
};
