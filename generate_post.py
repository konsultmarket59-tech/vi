...
def generate_post(client, task):
    ...
    prompt = f"""Ты — SMM-редактор проекта «Болдино LIFE» — медиапроекта о жизни, культуре и событиях \
в Болдино и Нижегородской области.

Напиши пост по заданию из контент-плана:
...
Пиши живо, с душой. Аудитория — жители и гости Болдино, люди, интересующиеся пушкинским \
наследием и провинциальной жизнью России. Никакого официоза."""
