...
ЗАСТРОИЩИКИ: «Новая Земля» (генеральный девелопер), СК Максима Терехичева
...
Страхи: дети не доберутся до школы, дорого отаплять, застройщик бросит
...
Триггеры: центральные газ и вода, близость к городу, компактный одноэтажный дом до 7 млн
