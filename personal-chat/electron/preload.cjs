...
contextBridge.exposeInMainWorld("api", {
  ...
  readStoriesDesign: (dir) => ipcRenderer.invoke("stories:readDesign", dir),
  ...
  transcribeVoice: (bytes) => ipcRenderer.invoke("voice:transcribe", bytes),
  ...
  libraryOpenVault: () => ipcRenderer.invoke("library:openVault"),
  libraryScan: () => ipcRenderer.invoke("library:scan"),
  libraryTranscribe: (paths, options) => ipcRenderer.invoke("library:transcribe", paths, options),
  libraryPolish: (paths) => ipcRenderer.invoke("library:polish", paths),
...
listGitHubWorkflows: (owner, repo) => ipcRenderer.invoke("github:listWorkflows", owner, repo),
  ...
  mediaStoryboardPrompt: (opts) => ipcRenderer.invoke("media:storyboardPrompt", opts),
  writeStoryboard: (payload) => ipcRenderer.invoke("media:writeStoryboard", payload),
  parseStoryboard: (text) => ipcRenderer.invoke("media:parseStoryboard", text),
  buildStoryboard: (request) => ipcRenderer.invoke("media:buildStoryboard", request),
  onMediaCollected: (cb) => {
  ...
  mediaWriteScript: (request) => ipcRenderer.invoke("media:writeScript", request),
  ...
  listPendingMedia: () => ipcRenderer.invoke("media:pending"),
  collectMedia: (id) => ipcRenderer.invoke("media:collect", id),
  forgetPendingMedia: (id) => ipcRenderer.invoke("media:forgetPending", id),
